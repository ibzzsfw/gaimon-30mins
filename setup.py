...
__help__ = """ModernDoc setup script :
setup : Install dependencies of Gaimon.
install : Install ModernDoc into machine.
...
class ModernDocSetup :
	def __init__(self) :
		...
		self.installPathList = [
			(f"{self.rootPath}/moderndoc", f"{self.sitePackagesPath}/moderndoc"),
		]
